...
import styles from './DiccionarioEDT.module.css'
import { Link } from 'react-router-dom'

export default function DiccionarioEDT() {
  return (
    <div id={styles.PrinDiv}>
      <embed
        src="/Diccionario EDT.pdf" // Asegúrate de colocar el archivo en la carpeta public
